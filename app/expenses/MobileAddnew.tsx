...
function MobileAddnew() {
    ...
    const {setCreateNewCat} = useContext(ExpenseContext)
  return (
    <div className={` flex-col mx-3 p-2 rounded-full border-2  md:px-6 sm:px-4  md:hidden sm:flex `}>
        ...
        <button className=' flex  rounded-md p-4 px-6 bg-orange-400' onClick={()=> setCreateNewCat(true)}><GrAdd className='mr-2 ' />Categrory</button>
        </div>
